  ...
  return (
    <Menu>
        ...
        <Menu.Content className="min-w-36 bg-primary text-primary-foreground z-999">
            ...
            <Menu.Item>
              <a href="/gnostikos_session" className="flex flex-1 hover:bg-[#B39EB5] rounded-[10px]"><LucideLink className="mr-2"/>Gnostikos Traveller</a>
            </Menu.Item>
            <Menu.Item>
            ...
            <Menu.Item>
              <a href="/doaist_formulas" className="flex flex-1 hover:bg-[#B39EB5] rounded-[10px]"><LucideLink className="mr-2"/> Doaist subduction</a>
            </Menu.Item>
        </Menu.Content>
    </Menu>
  );
